...
/* package neovim-haskell-syntax-0.1.0.0 */
#ifndef VERSION_neovim_haskell_syntax
#define VERSION_neovim_haskell_syntax "0.1.0.0"
#endif /* VERSION_neovim_haskell_syntax */
#ifndef MIN_VERSION_neovim_haskell_syntax
#define MIN_VERSION_neovim_haskell_syntax(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_neovim_haskell_syntax */
...
#endif /* VERSION_ghc_syntax_highlighter */
#ifndef MIN_VERSION_ghc_syntax_highlighter
#define MIN_VERSION_ghc_syntax_highlighter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 3)
#endif /* MIN_VERSION_ghc_syntax_highlighter */

/* package nvim-hs-1.0.0.3 */
#ifndef VERSION_nvim_hs
#define VERSION_nvim_hs "1.0.0.3"
...
#define CURRENT_COMPONENT_ID "neovim-haskell-syntax-0.1.0.0-inplace-neovim-haskell-syntax"
